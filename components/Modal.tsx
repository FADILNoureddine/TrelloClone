    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-hull items-center justify-center p-4 text-center">
            <Transition.Child
              as={Fragment}
              enter="ease-out duration-300"
              enterFrom="opacity-0"
            ...
            >
              <div className="fixed inset-0 flex items-center justify-center p-4">
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                    className="text-lg font-medium leading-6 tetx-gray-900 pb-2"
                  >
                    add task
                  </Dialog.Title>
                  <div className="mt-2">
                  ...
                  focus-visible:ring-blue-500 focus-visible:ring-offset-2"
                    ...
                    {image && (
                      <Image
                        ...
                        tarnsition-all duration-150 cursor-not-allowed"
                  ...
                  <div className="mt-4">
                    ...
                    text-sm font-meduim text-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2
